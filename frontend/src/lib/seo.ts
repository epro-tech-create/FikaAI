...
export function applySeo({
  ...
  else if (!document.title || document.title === "CCD-Attendance")
...
export function seoForApplication(application: string): SeoProps {
  if (application === "admin") {
    return {
      ...
      description:
        "Administrator attendance management console for CCD-Attendance. Manage courses, students and attendance records.",
      noindex: true,
    };
  }
  if (application === "instructor") {
    return {
      ...
      description:
        "Instructor attendance portal for CCD-Attendance. Create sessions and track verified student attendance.",
      noindex: true,
    };
  }
  return {

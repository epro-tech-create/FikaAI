  ...
  return (
    <section className="content-card" style={{ padding:16 }}>
      ...
      <div style={{ display:'grid', gap:8 }}>
        <Item k="gps" q="GPS says outside RAFIC" a="Allow Precise Location on iPhone (Safari → AA → Website Settings → Location → Allow + Precise ON). Ensure inside 100 m of RAFIC, accuracy <400 m. Wait 5 seconds for GPS to lock." />

  ...
  return (
    <section className="content-card" style={{ padding:16 }}>
      ...
      <div style={{ display:'grid', gap:8 }}>
        ...
        <Item k="early" q="Can't leave early / Check-out blocked until 15:00?" a="Check-out opens at 15:00. Scan the same RAFIC QR to check out any time 15:00–17:00. If you see 'Checkout opens at 11:00' after update, force-reload the page." />

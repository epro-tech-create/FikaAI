...
export const adminPages: Record<string, DataPageConfig> = {
  'face-enrolments': { title: 'Face Enrolments', description: 'Monitor enrolment readiness without exposing biometric data.', endpoint: '/admin/face-enrollments', columns: [{ key: 'studentName', label: 'Student' }, { key: 'membershipId', label: 'Student ID' }, { key: 'registrationNumber', label: 'Registration' }, { key: 'sampleCount', label: 'Samples' }, { key: 'isActive', label: 'Status' }, { key: 'createdAt', label: 'Enrolled' }] },

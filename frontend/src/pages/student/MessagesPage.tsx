          ...
          <div className="chat-new-panel">
            ...
            <div className="chat-user-results">
              ...
              {!userSearch.length && (
                ...
                >
                  Type to find instructor or student
                </small>
              )}
            </div>
          </div>
        ...
        <div className="chat-convs" ref={listRef}>
          {filteredConvs.length === 0 && (
            <div className="chat-empty">
              No chats yet. Tap ＋ to start a WhatsApp-style chat with an
              instructor.
            </div>
          )}
          {filteredConvs.map((c) => (
        ...
        {!activeId ? (
          <div className="chat-welcome">
            <div className="chat-welcome-card">
              ...
              <p>
                Select a chat or start a new one. Chats are 1:1 between you and
                instructors (or other students). Messages persist, show read
                counts, and poll every few seconds — upgradeable to WebSocket.
              </p>
              <button
